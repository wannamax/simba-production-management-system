...
export default function ShopfloorWorkBoardDisplay() {
  ...
  return <div className="shopfloor-display">
    ...
    <footer><span>Phiên bản {board.published_version} · Cập nhật {dayjs(board.published_at).format('HH:mm DD/MM/YYYY')}{board.status === 'CLOSED' ? ' · ĐÃ CHỐT NHẬT KÝ' : ''}</span><span>Simba PMS - Version: 2.6.0-J</span></footer>
  </div>;
}
